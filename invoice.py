...
class Invoice:
    ...
    def searchInvoice():
        ...
        try:
            ...
            if dni == "" or Conexion.searchClient(dni):
                ...
                globals.ui.lblAddressFactura.setText(
    ...
    def reloadInvoice():
        ...
        try:
            formfact = [
                globals.ui.lblNameFactura,
                globals.ui.lblAddressFactura,
                globals.ui.lblStatusFactura,
                globals.ui.lblFacturaType,
                globals.ui.lblMobileFactura,
                globals.ui.lblFechaFactura,
                globals.ui.lblNumFactura,
                globals.ui.txtDniFactura,
            ]
    ...
    def loadTableInvoice(self=None):
        ...
        try:
            ...
            header = globals.ui.tblFactura.horizontalHeader()
            header.setSectionResizeMode(3, QtWidgets.QHeaderView.ResizeMode.Fixed)
            globals.ui.tblFactura.setColumnWidth(3, 36)
            globals.ui.tblFactura.setColumnWidth(0, 55)

            for record in records:
                globals.ui.tblFactura.setColumnWidth(3, 34)
                globals.ui.tblFactura.setRowCount(index + 1)
                globals.ui.tblFactura.setItem(index, 0, QtWidgets.QTableWidgetItem(record[0]))
                globals.ui.tblFactura.setItem(index, 1, QtWidgets.QTableWidgetItem(record[1]))
                globals.ui.tblFactura.setItem(index, 2, QtWidgets.QTableWidgetItem(record[2]))
                ...
                globals.ui.tblFactura.item(index, 2).setTextAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        try:
            ...
            if is_row_complete:
                if not Conexion.existeFacturaSales(fact):
                    ...
                    sale = [
                        int(globals.ui.lblNumFactura.text()),
